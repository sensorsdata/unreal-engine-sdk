...
## SDK 简介
Unreal Engine SDK 实现了 Unreal Engine 5 内置的 Analytics 服务，同时也支持通过 C++ 代码调用接口上报数据，目前支持 Android、iOS、 Windows 和 macOS 平台。

## 基本要求
Unreal Engine [5.0](https://docs.unrealengine.com/5.0/zh-CN/unreal-engine-5.0-release-notes/) 及以上版本
